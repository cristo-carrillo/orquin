...
class Pedidos extends Controllers{
	use TTipoPago;
		...
		public function Pedidos()
		{
			...
			$data['page_title'] = "PEDIDOS <small>Panaderia Orquin</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - Panaderia Orquin";
		$data['page_title'] = "PEDIDO <small>Panaderia Orquin</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Panaderia Orquin";
		...
		if($_SESSION['permisosMod']['u'] and $_SESSION['userData']['idrol'] != RCLIENTES){
			if($pedido == ""){
				...
				if(empty($requestPedido)){
					...
					$requestPedido['tipospago'] = $this->getTiposPago();
