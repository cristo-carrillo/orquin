      ...
      <?php if(!empty($_SESSION['permisos'][2]['r'])){ ?>
        ...
        <li>
          <a class="app-menu__item" href="<?= base_url();?>clientes">
            <i class="app-menu__icon fa fa-male" aria-hidden="true"></i>
        ...
        <?php if(!empty($_SESSION['permisos'][4]['r']) || !empty($_SESSION['permisos'][6]['r'])){ ?>
          ...
          <a class="app-menu__item" href="#" data-toggle="treeview">
            ...
            <span class="app-menu__label">Panaderia</span>
            <i class="treeview-indicator fa fa-angle-right"></i>
          </a>
          ...
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="<?= base_url();?>categorias" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i>Categorias</a></li>
            <?php }?>
          </ul>
        </li>
