...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Panaderia Orquin">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Cristo Carrillo">
    <meta name="theme-color" content="rgb(194,126,75)">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url();?>dashboard">Panaderia Orquin</a>
