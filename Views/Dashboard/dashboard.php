    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Ultimos Perdidos</h3>
          ...
          <div class="tile">
            <div class="container-title">
              ...
              <div class="dflex">
                ...
                <button type="button" class="btnVentaMes btn btn-info btn-sm" onclick="fntSearchVMes()"> <i class="fas fa-search"></i> </button>
              </div>
            </div>
          ...
          <div class="tile">
            <div class="container-title">
              ...
              <div class="dflex">
                ...
                <button type="button" class="btnVentaAnio btn btn-info btn-sm"  onclick="fntSearchVAnio()"> <i class="fas fa-search"></i> </button>
              </div>
            </div>
   ...
   <script >
     ...
     Highcharts.chart('graficaAnio', {
        ...
        tooltip: {
            pointFormat: 'Ventas del <?= $data['ventasAnio']['anio'] ?>: <b>{point.y:.1f} $</b>'
        },
        series: [{
            name: 'Population',
            data: [
